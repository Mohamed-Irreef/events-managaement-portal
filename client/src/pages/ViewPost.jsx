...
const ViewPost = ({roleAuthorized}) => {
  ...
  useEffect(()=>{
    ...
    .then((res)=>{
      ...
      const totalPost =res.data.allPosts;
      let postsFromServer = totalPost.filter((post)=>{return(post.adminId===id)});
      let newPostData = [];
  ...
  return (
    <>
      <div className="event-page"> {/* Event Page */}
        <h2 className="text-2xl text-center mt-4 font-medium ">Post History</h2>
